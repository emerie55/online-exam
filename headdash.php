...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span> <a href="headdash.php" class="log log1">'.$email.'</a>&nbsp;|&nbsp;<a href="logout.php?q=headdash.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="headdash.php?q=1">Applicants</a></li>
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="headdash.php?q=4">Add Staff</a></li>
            <li><a href="headdash.php?q=5">Remove Staff</a></li>
          </ul>
        </li>

        <li class="dropdown <?php if(@$_GET['q']==41 || @$_GET['q']==51) echo'active'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quiz<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="headdash.php?q=41">Add Quiz</a></li>
            <li><a href="headdash.php?q=51">Remove Quiz</a></li>
          </ul>
        </li>

        <li class="dropdown <?php if(@$_GET['q']==6 || @$_GET['q']==7) echo'active'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pin<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="headdash.php?q=6">Add Pin</a></li>
            <li><a href="headdash.php?q=7">Remove Pin</a></li>
          </ul>
        </li>
      </ul> 
          </div><!-- /.navbar-collapse -->
...
echo  '<div class="panel" style="overflow:auto;"><table class="table table-striped title1">
...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$sahi.'</td><td>'.$wrong.'</td><td>'.$time2.'&nbsp;min</td>
	</tr>';
}
else
{
...
echo  '<div class="panel title" style="overflow:auto;">
<table class="table table-striped title1" >
<tr ><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Score</b></td></tr>';
$c=0;
...
echo  '<div class="panel" style="overflow:auto;"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Pin</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Staff Details</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="email" name="email" placeholder="Enter Admin Email" class="form-control input-md" type="email" required>
...
<!--add quiz start-->
<?php
if(@$_GET['q']==41 && !(@$_GET['step']) ) {
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Quiz Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addquiz1"  method="POST">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Enter marks on right answer" class="form-control input-md" type="number" required>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select style="" name="time" class="form-control input-md" required>
...
<?php
if(@$_GET['q']==41 && (@$_GET['step'])==2 ) {
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form class="form-horizontal title1" name="form" action="update.php?q=addqns1&n='.@$_GET['n'].'&eid='.@$_GET['eid'].'&ch=4 "  method="POST">
<fieldset>
';
...
while($row = mysqli_fetch_array($result)) {
    ...
    $time2 = $time/60;
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time2.'&nbsp;min</td>
	<td><b><a href="update.php?q=rmquiz1&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div>';
...
<?php
if(@$_GET['q']==6) {
  $freq= []; $num=rand(1,1000000000); $times=2; while ($times --> 0){ while (in_array($num,$freq)) $num=rand(1,1000000000); $freq[]=$num; }
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b class="icofont-qr-code"> Pin Upload</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="pinadd.php?q=headdash.php?q=6"  method="POST">
<fieldset>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="pin" name="pin" class="form-control input-md" type="text" value="'.$num.'" readonly style="font-weight:bold;">
...
$result = mysqli_query($con,"SELECT * FROM pi_n_code order by id desc") or die('Error');
echo  '<div class="panel" style="overflow:auto;"><table class="table table-striped title1">
<tr><td><b>SN</b></td><td><b>Email</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
  ...
  echo '<tr><td>'.$c++.'</td><td>'.$pin.'</td>
  <td><a title="Delete Pin" href="update.php?demail2='.$pin.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
}
$c=0;
echo '</table></div>';
